        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleStatus = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__8AFACE1A5FFA3C8C", x => x.RoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountRoleId = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((3))")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accounts", x => x.AccountId);
                    table.ForeignKey(
                        name: "FK__Accounts__Accoun__17F790F9",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Carts__51BCD7B71DAB11B5", x => x.CartId);
                    table.ForeignKey(
                        name: "FK__Carts__AccountId__6A30C649",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__727D8793648D3F98", x => x.Itemid);
                    table.ForeignKey(
                        name: "FK__CartItems__CartI__6D0D32F4",
                        column: x => x.CartId,
